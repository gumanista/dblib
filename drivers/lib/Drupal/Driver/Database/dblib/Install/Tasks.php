...
/**
 * @file
 * Contains \Drupal\Driver\Database\dblib\Tasks.
 */
...
class Tasks extends InstallTasks {
   ...
   * {@inheritdoc}
   */
  protected $pdoDriver = 'dblib';

  /**
   * Constructs a \Drupal\Driver\Database\dblib\Install\Tasks object.
   */
...
EOF
  ...
  function enableModule() {
    ...
    //$handler->enable(array('dblib'), FALSE);
  }
