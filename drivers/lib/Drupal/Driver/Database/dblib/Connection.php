...
/**
 * @file
 * Contains \Drupal\Driver\Database\dblib\Connection.
 */
...
use Drupal\Driver\Database\dblib\TransactionIsolationLevel as DatabaseTransactionIsolationLevel;
use Drupal\Driver\Database\dblib\TransactionScopeOption as DatabaseTransactionScopeOption;
use Drupal\Driver\Database\dblib\TransactionSettings as DatabaseTransactionSettings;
use Drupal\Driver\Database\dblib\Context as DatabaseContext;
...
class Connection extends DatabaseConnection {
  ...
  public function prepareQuery($query, array $options = array()) {
    ...
    // http://blogs.iis.net/bswan/archive/2010/12/09/how-to-change-database-settings-with-the-pdo-dblib-driver.aspx
